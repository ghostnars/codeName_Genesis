 ...
 */
public class EligeHabito6 extends Estilos {
	...
	public EligeHabito6() {
		...
		VerticalFieldManager contenido = new VerticalFieldManager(VerticalFieldManager.FIELD_HCENTER);
		contenido.setMargin(0, 0, 0, 5);
		
		/** Start Texto Detalle **/
		RichTextField titulo3 = new RichTextField(
				"¿A QUÉ HORAS TE AVISAMOS?",
		...
		/** Start Aplicando Subtitulo **/
		DateField hora = new DateField("", System.currentTimeMillis(), DateField.TIME | DateField.FIELD_HCENTER);
		hora.setMargin(8,80,0,0);
		/** End Aplicando Subtitulo **/
	...
	public boolean onClose() {
		pushScreenBack(new EligeHabito5());
		return true;
	}
}
