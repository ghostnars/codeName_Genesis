 ...
 */
public class EligeHabito3 extends Estilos {
	...
	public EligeHabito3() {
		...
		/** Start Aplicando Subtitulo **/
		LabelField lbfSwitch = new LabelField(
				"¿QUIERES QUE TE AVISEMOS?",
				RichTextField.FIELD_HCENTER);
		lbfSwitch.setFont(fLite);
		lbfSwitch.setMargin(8, 0, 0, 0);
		//add(lbfSwitch);
		/** End Aplicando Subtitulo **/
		
		/**campo genero*/
       	HorizontalFieldManager hfmYesNo = new HorizontalFieldManager(HorizontalFieldManager.FIELD_HCENTER);
        LabeledSwitch callSwitch = new LabeledSwitch(switch_left, switch_right, switch_left_focus, switch_right_focus, "Si", "No", true );
        callSwitch.setFont(fLite);
	...
	public boolean onClose() {
		pushScreenBack(new EligeHabito2());
		return true;
	}
}
